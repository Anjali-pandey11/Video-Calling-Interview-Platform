        ...
        <div className='space-y-8'>
         ...
         {/*CTA Buttons  */}
          ...
          <div className='stats stats-vertical lg:stats-horizontal bg-base-100 shadow-lg'>
            ...
            <div className='stat-tile'>Active Users</div>
            </div>
            <div className='stat'>
            <div className='stat-value text-primary'>50K+</div>
            <div className='stat-tile'>Sessions</div>
            </div>
            <div className='stat'>
            <div className='stat-value text-primary'>99.9%</div>
            <div className='stat-tile'>Uptime</div>
            </div>
          </div>
      ...
      <div className='max-w-7xl mx-auto px-4 py-20'>
       ...
       <div className='grid md:grid-cols-3 gap-8'>
        ...
        <div className='card bg-base-100 shadow-xl'>
          ...
          Crystal clear video and audio for seamless communication during interview</p>
          </div>
        </div>
        ...
        <div className='card bg-base-100 shadow-xl'>
          ...
          <p className='text-base-content/70'>
          Collaborate in real-time with syntax hightlighting and multiple language support</p>
          </div>
        </div>
